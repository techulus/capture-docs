---
title: Batch PDF
description: Generate multiple PDFs in a single API request with Capture batch processing. Process bulk PDF generation with custom options, webhooks, and HMAC-SHA256 authentication.
---
