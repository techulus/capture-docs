---
title: Get Started
description: Get started with Capture API in minutes. Learn authentication, hash generation, and how to create your first screenshot or PDF request with complete code examples.
---
