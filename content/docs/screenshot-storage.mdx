...
description: Optimize screenshot delivery with S3 storage integration, custom ACL settings, CDN caching, and automatic file naming. Control upload behavior and access permissions.
---
