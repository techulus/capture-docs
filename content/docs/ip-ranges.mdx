...
description: Allowlist Capture API traffic in your firewall by using our outbound IP address ranges. Get the current list of IP ranges in CIDR notation via our JSON endpoint.
---
