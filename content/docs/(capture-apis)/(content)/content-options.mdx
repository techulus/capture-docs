...
description: Capture fully rendered HTML content including JavaScript-generated elements with Capture API. Extract complete page content with headers, styles, and dynamic content.
---
