...
description: Configure HTTP Basic Authentication and custom user agent headers for capturing protected content, internal applications, and authenticated websites with Capture API.
---
