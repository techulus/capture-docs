...
description: Optimize screenshot output with PNG, JPEG, and WebP formats. Configure image quality, transparency, automatic format selection, and custom resizing options.
---
