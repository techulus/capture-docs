...
description: Extract comprehensive page metadata including title, description, author, logo, language, and Open Graph data using Capture API. Get structured JSON responses for any website.
---
