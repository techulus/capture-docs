...
<Callout type="warn">
Batch requests require an S3 bucket or S3-compatible storage (e.g., Cloudflare R2, MinIO) to be configured in your project settings. The generated files will be uploaded to this storage.
</Callout>
