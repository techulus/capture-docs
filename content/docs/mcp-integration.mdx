...
description: Connect Capture API to Claude Code and Claude Desktop using Model Context Protocol. Generate screenshots, PDFs, and extract content directly from AI conversations.
---
