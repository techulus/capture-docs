...
description: Configure viewport width, height, and device pixel ratio for screenshots. Set custom dimensions from mobile (375px) to 4K displays (3840px) with retina support.
---
