...
description: Generate PDFs from password-protected websites using HTTP Basic Authentication and custom user agent headers. Access internal applications and authenticated content.
---
