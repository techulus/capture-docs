---
title: SDK Overview
description: Official Capture API SDKs for Node.js, Go, Rust, Python, and Ruby. Integrate screenshot, PDF, and content capture capabilities with TypeScript support, async/await, and comprehensive examples.
---
